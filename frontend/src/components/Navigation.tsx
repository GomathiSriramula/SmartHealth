...
const Navigation: React.FC<NavigationProps> = ({ onBackToLanding }) => {
  return (
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">HealthGuard Dashboard</h1>
                <p className="text-sm text-gray-500">Smart Community Health Monitoring</p>
              </div>
            </div>
          </div>
